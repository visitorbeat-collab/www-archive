...
No verified recording date.

No verified environment of origin.
...
Later events resemble earlier events without reproducing them exactly.
...
Apparent phonetic similarities are unstable across repeated listening.
...
Exact periodicity is not established.
...
It may also reflect broad pattern categories imposed during reconstruction.
